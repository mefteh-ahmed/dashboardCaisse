...
<div id="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
  ...
  <div class="row">
  <div class="col-sm-4">
    <h3>Total des retour d'achats En Dinar <span class="text-primary"><div id="a">0.000</div></span></h3>
    </div>
  </div>
  ...
  <h4 class="text-primary">Récapitulatif des retour d'achats Par Exercice</h4>
  <div class="col-sm-8">
